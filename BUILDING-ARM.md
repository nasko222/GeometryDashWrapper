# Building Geometry Dash ARM Wrapper 0.9.4-arm-v22beta-bringup7
...
```text
dist-arm-wrapper-v22beta-bringup7\
```
...
Press **F2** to bypass the beta's device-specific broken editor button and enter My Levels directly.
...
dist-arm-wrapper-v22beta-bringup7\RUN_V22_RAW_SO_PROBE.cmd
```
