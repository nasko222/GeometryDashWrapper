# Building Geometry Dash ARM Wrapper 0.9.4-arm-v22beta-bringup14
...
```text
dist-arm-wrapper-v22beta-bringup14\
```

Launch the copied APK with:

```bat
dist-arm-wrapper-v22beta-bringup14\RUN_V22_SELECTED_APK.cmd
```
