...
def main() -> int:
    ...
    (output / "README-ARM-TEST.txt").write_text(
        ...
        "including successful boots. Bootstrap12 keeps the high-resolution "
        ...
        "GJGameLevel data across load/editor/save boundaries, blocks and "
        "identifies host writes into immutable ELF data, logs save-file byte "
        "totals, and reuses decoded effect caches before reopening the APK. "
