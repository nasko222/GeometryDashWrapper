...
def main() -> int:
    ...
    (output / "README-ARM-TEST.txt").write_text(
        ...
        "including successful boots. Bootstrap13 keeps the high-resolution "
        ...
        "same-size free blocks, recycles free metadata at the ceiling, "
        ...
        "atoi/atol bridge's false end-pointer write, blocks and identifies "
