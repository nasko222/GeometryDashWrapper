...
def main() -> int:
    ...
    (output / "README-ARM-TEST.txt").write_text(
        ...
        "including successful boots. Bootstrap11 keeps the high-resolution "
        ...
        "ARM comparator callbacks for Bionic qsort, restores a damaged 1.4 "
        "Attempt literal, watches immutable ELF data for illegal writes, and "
        "logs save-file byte totals. "
