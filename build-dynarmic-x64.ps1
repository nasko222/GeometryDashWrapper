...
$Output = Join-Path $Root "dist-arm-wrapper-v22beta-bringup8"
...
$BuilderRevision = "dynarmic-x64-builder19-v22beta-armv7-bringup8-level-handoff-edit-button"
...
$V22Notes = Join-Path $Root "V22BETA-BRINGUP8-NOTES.md"
if (Test-Path $V22Notes) { Copy-Item -Force $V22Notes (Join-Path $Output "V22BETA-BRINGUP8-NOTES.md") }
