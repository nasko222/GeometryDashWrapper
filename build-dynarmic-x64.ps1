...
$Output = Join-Path $Root "dist-arm-wrapper-v22beta-bringup7"
...
$BuilderRevision = "dynarmic-x64-builder18-v22beta-armv7-bringup7-low-inflate-f2-editor"
...
$V22Notes = Join-Path $Root "V22BETA-BRINGUP7-NOTES.md"
if (Test-Path $V22Notes) { Copy-Item -Force $V22Notes (Join-Path $Output "V22BETA-BRINGUP7-NOTES.md") }
