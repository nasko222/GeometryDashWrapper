...
$Output = Join-Path $Root "dist-arm-wrapper-v22beta-bringup13"
...
$BuilderRevision = "dynarmic-x64-builder24-v22beta-armv7-bringup13-large-level-visual-jump-waveout"
...
$V22Notes = Join-Path $Root "V22BETA-BRINGUP13-NOTES.md"
if (Test-Path $V22Notes) { Copy-Item -Force $V22Notes (Join-Path $Output "V22BETA-BRINGUP13-NOTES.md") }
