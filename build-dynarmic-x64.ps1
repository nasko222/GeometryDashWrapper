...
$Output = Join-Path $Root "dist-arm-wrapper-v22beta-bringup4"
...
$BuilderRevision = "dynarmic-x64-builder15-v22beta-armv7-bringup4-runtime-fixes"
...
$V22Notes = Join-Path $Root "V22BETA-BRINGUP4-NOTES.md"
if (Test-Path $V22Notes) { Copy-Item -Force $V22Notes (Join-Path $Output "V22BETA-BRINGUP4-NOTES.md") }
