...
$Output = Join-Path $Root "dist-arm-wrapper-v22beta-bringup6"
...
$BuilderRevision = "dynarmic-x64-builder17-v22beta-armv7-bringup6-guest-string-canplay"
...
$V22Notes = Join-Path $Root "V22BETA-BRINGUP6-NOTES.md"
if (Test-Path $V22Notes) { Copy-Item -Force $V22Notes (Join-Path $Output "V22BETA-BRINGUP6-NOTES.md") }
