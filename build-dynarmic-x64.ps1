...
$Output = Join-Path $Root "dist-arm-wrapper-v22beta-bringup5"
...
$BuilderRevision = "dynarmic-x64-builder16-v22beta-armv7-bringup5-level-decode-editor"
...
$V22Notes = Join-Path $Root "V22BETA-BRINGUP5-NOTES.md"
if (Test-Path $V22Notes) { Copy-Item -Force $V22Notes (Join-Path $Output "V22BETA-BRINGUP5-NOTES.md") }
